...
from comde.comde_modules.low_policies.naive.architectures.base.gpt_modules import FlaxConv1D
...
class Block(nn.Module):
	...
	def setup(self) -> None:
		self.attn = CausalSelfAttention(self.embed_dim, self.num_heads, use_bias=self.use_bias)
