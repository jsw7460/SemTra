...
class XAttnGPT(nn.Module):
    ...
    def init(
        ...
        **kwargs,
        ...
        return super().init(
            rngs,
            obs_action_tokens=obs_action_tokens,
            prompt_tokens=prompt_tokens,
            prompt_mask=prompt_mask,
            batch_first=batch_first,
            obs_action_masks=obs_action_masks,
            **kwargs,
        )
    ...
    def __call__(
        ...
        *,
        ...
        obs_action_tokens += position_embeds
        obs_action_tokens = self.dropout(obs_action_tokens, deterministic=deterministic)
        ...
        for self_attn, xattn in zip(self.h, self.xattns):
            ...
            obs_action_tokens = self_attn(
                obs_action_tokens, mask=obs_action_masks, deterministic=deterministic,
            )[0]
