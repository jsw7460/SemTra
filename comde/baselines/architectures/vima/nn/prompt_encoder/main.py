...
class T5PromptEncoder(nn.Module):
    def __init__(self):
        ...
        self.t5 = cast(T5EncoderModel, T5EncoderModel.from_pretrained("t5-base"))
...
class T5EncoderModel(FlaxT5PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.shared = nn.Embed(config.vocab_size, config.d_model)
    ...
    def _prune_heads(self, heads_to_prune):
        ...
        for layer, heads in heads_to_prune.items():
            self.encoder.module[layer].attention.prune_heads(heads)
    ...
    ) -> Union[Tuple[jnp.ndarray], FlaxBaseModelOutput]:
        return_dict = (
...
class T5Stack(FlaxT5PreTrainedModel):
    config: T5Config
