...
class TargetAllPromptDT(VLPromptDT):
	"""
	...
	def _excluded_save_params(self) -> List:
		return TargetAllPromptDT.PARAM_COMPONENTS

	def _get_save_params(self) -> Dict[str, Params]:
		params_dict = {}
		for component_str in TargetAllPromptDT.PARAM_COMPONENTS:
