...
from .customed.gpt_modules import FlaxGPT2ModuleWoTimePosEmb
from comde.comde_modules.common.scaler import Scaler
from comde.comde_modules.common.utils import create_mlp


class PrimDecisionTransformer(nn.Module):
	"""
	...
	def forward(
		...
		# rtgs (0), observations (1), or actions (2); i.e. x[:,1,t] is the token for s_t
