...
class ContinuousLSTM(BaseEnvEncoder, IJaxSavable, ITrainable):
	...
	def __init__(
		...
		super(ContinuousLSTM, self).__init__(
			seed=seed,
			cfg=cfg,
	...
	def _excluded_save_params(self) -> List:
		return ContinuousLSTM.PARAM_COMPONENTS

	def _get_save_params(self) -> Dict[str, Params]:
		params_dict = {}
		for component_str in ContinuousLSTM.PARAM_COMPONENTS:
